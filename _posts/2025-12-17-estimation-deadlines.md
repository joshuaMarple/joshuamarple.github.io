---
layout: post
title: "Deadlines aren't for devs; you need them anyway"
date: 2025-12-17
category: tech
---

Deadlines get a bad rap in software. But they're not the problem — we just target them at the wrong people.
...
In response, project leads begin to look askance at the estimates created by the devs; no longer trusting their devs' technical judgement, they push and pry on every number that seems too large. They ask for more and more detailed breakdowns, which leads to project inflation before the project has even begun.

Finger pointing and blaming before we've started — what a miserable project already!

## What are deadlines even for?

Given this dynamic, many software engineers believe that deadlines are unnecessary, bad, or misleading.[^2] I think this is a mistake — deadlines are one of the most important tools that project managers have for communicating with stakeholders and customers about when to expect something in their hands.
...
Rather than using deadlines as an exercise in destroying team trust, a well-crafted deadline can be a relieving force for a team. It's a shield against a different insidious anti-pattern: scope creep. By having a clear deadline, you can cut optional features to deliver something useful to a customer even sooner. But how do we avoid the downsides that deadlines give?
...
The project lead takes all of these factors into account and comes up with a calendar date. As a lower bound, the deadline should *at least* allow for total estimated work ÷ number of developers.

## What happens when God laughs?[^5]
...
Finally, maybe the deadline was too aggressive. The estimates were off, the project slipped, shit happened. **It's OK.**
...
2. Give them a new deadline (and maybe bake a bit more time into it)
   ...
   Instead, cut your losses and commit to pushing it out. You need room to pivot in case another problem comes up. Give yourself at least the same amount of leeway you had at the project start (and consider giving it more!).
...
[^5]: [Man plans, God laughs](https://www.yiddishwit.com/gallery/laugh.html) — a Yiddish proverb.
